...
CREATE TABLE `employees` (
  ...
  KEY `idx_dept_position` (`department`,`position`)
...
CREATE TABLE `leave_request` (
  ...
  KEY `idx_leave_date` (`leave_data`),
  KEY `idx_leave_status` (`status`),
  KEY `idx_leave_date_status` (`leave_data`,`status`),
...
INSERT INTO `leave_request` VALUES (1,1,'2025-07-22','Sick Leave','Approved'),(2,1,'2025-12-01','Personal','Pending'),(3,2,'2025-07-15','Family Responsibility','Denied'),(4,2,'2025-12-02','Vacation','Approved'),(5,3,'2025-07-10','Medical Appointment','Approved'),(6,3,'2025-12-05','Personal','Pending'),(7,4,'2025-07-20','Bereavement','Approved'),(8,5,'2025-12-01','Childcare','Pending'),(9,6,'2025-07-18','Sick Leave','Approved'),(10,7,'2025-07-22','Vacation','Pending'),(11,8,'2025-12-02','Medical Appointment','Approved'),(12,9,'2025-07-19','Childcare','Denied'),(13,10,'2024-12-03','Vacation','Pending');
...
CREATE TABLE `payroll_data` (
  ...
  KEY `idx_payroll_salary` (`finalSalary`),
  KEY `idx_payroll_hours` (`hoursWorked`),
...
-- Dump completed on 2026-02-05  8:34:10
